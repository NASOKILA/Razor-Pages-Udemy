...
namespace TasteRestaurant.Data.Migrations
{
    ...
    [Migration("20181118233635_OrdersAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TasteRestaurant.Data.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TasteRestaurant.Data.OrderDetails", b =>
                {
                    ...
                    b.HasOne("TasteRestaurant.Data.OrderHeader", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("TasteRestaurant.Data.OrderHeader", b =>
                {
                    b.HasOne("TasteRestaurant.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
